<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
 ...
 <hr class="sidebar-divider">
    <li class="nav-item {{Request::is('admin/service/create') || Request::is('admin/services') ? 'active' : ''}}">
        <a class="nav-link {{Request::is('admin/service/create') || Request::is('admin/services') ? '' : 'collapsed'}}" href="#" data-toggle="collapse" data-target="#collapseservice"
            aria-expanded="{{Request::is('admin/service/create') || Request::is('admin/services') ? true : false}}" aria-controls="collapseservice">
            <i class="fab fa-discourse"></i>
            <span>Services</span>
        </a>
        <div id="collapseservice" class="collapse {{Request::is('admin/service/create') || Request::is('admin/services') ? 'show' : ''}}" aria-labelledby="headingservice" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item {{Request::is('admin/service/create') ? 'active' : ''}}" href="{{ url('/admin/service/create') }}">Add service</a>
                <a class="collapse-item {{ Request::is('admin/services') ? 'active' : ''}}" href="{{ url('/admin/services') }}">View services</a>
                <a class="collapse-item {{ Request::is('admin/services/trash') ? 'active' : ''}}" href="{{ url('/admin/services/trash') }}">Trash</a>
            </div>
        </div>
    </li>
    ...
    <li
        class="nav-item {{ Request::is('admin/featured/services') || Request::is('admin/featured/categories') ? 'active' : '' }} ">
        <a class="nav-link {{ Request::is('admin/featured/services') || Request::is('admin/featured/categories') ? '' : 'collapsed' }} "
            href="#" data-toggle="collapse" data-target="#collapseFeatured"
            aria-expanded="{{ Request::is('admin/featured/services') || Request::is('admin/featured/categories') ? true : false }}"
